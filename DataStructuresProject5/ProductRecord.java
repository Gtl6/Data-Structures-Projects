...
public class ProductRecord {
  ...
  public int hashCode() {
    //If you wanted to change the name or the price, it should still give you the same object, so
    //I'm going to just take into account the defining factors (color, style, material, pattern)

    return colorCode * 3 + styleCode * 7 + materialCode * 31 + patternCode * 37;
  }
}