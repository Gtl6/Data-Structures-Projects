...
public class LinkedStackTest {
  ...
  public void measurePushAndPopTime(ArrayStack<Double> as, LinkedStack<Double> ls) {
    long arrayTime = 0;
    long linkedTime = 0;
    long now = 0;
  ...
  public void measurePopTime(ArrayStack<Double> as, LinkedStack<Double> ls) {
    long arrayPopTime = 0;
  ...
  public void measurePushTime(ArrayStack<Double> as, LinkedStack<Double> ls, int size) {
